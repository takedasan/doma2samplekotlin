...
/** */
@javax.annotation.Generated(value = { "Doma", "2.19.3" }, date = "2018-12-03T23:45:01.601+0900")
public class PersonDomaDaoImpl extends org.seasar.doma.internal.jdbc.dao.AbstractDao implements jp.takeda.doma2sample.dao.PersonDomaDao {
    ...
    @Override
    public java.util.List<jp.takeda.doma2sample.model.PersonEntity> selectAll() {
        ...
        try {
            ...
            java.util.List<jp.takeda.doma2sample.model.PersonEntity> __result = __command.execute();
            __query.complete();
